...
public class Jaccouse extends LinearOpMode {
    ...
    private final double defaultOrientationAngle = 0;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad2.start) {
                ...
                if (homingHand.isClicked()) this.handRail.resetPotAndHand();
                continue;
            }
...
//			}
            ...
            // Carousel control
            double carouselBoost = gamepad1.left_trigger == 0 ? handRail.freightIn() ? 1 : 0 : gamepad1.left_trigger;
