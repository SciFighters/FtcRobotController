...
public class DriveClass {
	...
	public DriveClass(LinearOpMode opMode, org.firstinspires.ftc.teamcode.ultimate_goal.util.DriveClass.ROBOT robot, Location startingPosition) {
		this.opMode = opMode;
		this.startingPosition = startingPosition;


		if (robot == org.firstinspires.ftc.teamcode.ultimate_goal.util.DriveClass.ROBOT.SCORPION) {
			this.forwardTicksPerMeter = 2455;
			this.strafeTicksPerMeter = 2587;
		} else if (robot == org.firstinspires.ftc.teamcode.ultimate_goal.util.DriveClass.ROBOT.COBALT) {
