...
public class IMU_Integrator implements BNO055IMU.AccelerationIntegrator {
	...
	public IMU_Integrator(BNO055IMU imu, HardwareMap hw, double forwardTicksPerMeter, double strafeTicksPerMeter, boolean useDahsboard, Point origin, Point direction) {
		this.imu = imu;
		// Constructor
