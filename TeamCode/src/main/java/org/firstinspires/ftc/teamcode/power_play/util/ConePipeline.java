...
//        Mat smallFrame = new Mat(frame, new Range(frame.height() / 2, frame.height()));
        ...
        Scalar min_yellow = new Scalar(8, 130, 160); // Park 1
        Scalar max_yellow = new Scalar(60, 255, 255);
        Scalar min_pink = new Scalar(60, 255, 255); // Park 2
        Scalar max_pink = new Scalar(60, 255, 255);
        Scalar min_green = new Scalar(60, 255, 255); // Park 3
        Scalar max_green = new Scalar(60, 255, 255);
